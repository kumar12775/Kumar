...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕B4 T4▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;91m☞ Auther     : thankgod
\033[1;92m☞ WhatsApp  08139530228
...
def menu():
	...
	print (S + '[' + P + '☞3' + S + ']' + S + ' thankgod1 Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/thankgod1')
	    ...
	    psb('WhatsApp Num 08139530228✓')
	    psb('WellCome To thankgod121)
	    psb('Congratulations thankgod1 Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Kumar✓')
	    psb('🔓Password ☆ @thankgod1Q✓)
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/thankgod && python2 B4.py')
	elif bm =='3':
	elif bm =='4':
